...
export function CTA() {
  return (
    <section id="contact" className="px-6 lg:px-10 pb-6">
      <div className="mx-auto max-w-[1400px]">
        <div className="relative overflow-hidden aspect-[16/9] md:aspect-[21/9] bg-stone-950 border border-stone-300">
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-8 md:p-12 lg:p-16">
            <div className="max-w-xl">
              <h2 className="font-light tracking-[-0.02em] text-white text-4xl md:text-5xl lg:text-6xl leading-[1]">
                Shape Your Vision
                <br />
                Into Reality
              </h2>
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              ...
              <a
                ...
                className="self-start md:self-auto inline-flex items-center gap-2 bg-white text-stone-950 text-[12px] uppercase tracking-wider px-6 py-3 hover:bg-stone-200 transition-colors"
              >
                Get in Touch →
              </a>
            </div>
